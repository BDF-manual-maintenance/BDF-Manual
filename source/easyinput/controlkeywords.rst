...
.. note::
  ...
  * 默认原则: 如果指定哈密顿，BDF将根据基函数选择合适的哈密顿。对于考虑了相对论效应的全电子基组或非相对论全电子基组，标量项采用 **sf-X2C** 哈密顿，自旋轨道耦合算符采用 **DKH1e+mf1c** ，用户可以强行设置为 **DKH1e**, 对于轻元素会有较大的误差。对于相对论有效势及基组，有效势已经考虑了相对论效应，无需设置哈密顿，SOC算符默认为BP。
