    ...
    tokens = {
        ...
        "keywords": [
            (words((
                ...
                'Spinmulti','icg','igiao','igatom','cgcoord','cgunit','solvent','solmodel','cavity','acidHRadius','radii','vdWScale','crit_vec','gridtol','locales','iwindow','dielectric','opticalDielectric','units','uatm','cavityNGrid','cavityPrecision','cosmoFactorK','refractiveIndex','HBondAcidity','HBondBasicity','SurfaceTensionAtInterface','CarbonAromaticity','ElectronegativeHalogenicity','solventAtomicSASRadii','radiiForCavEnergy','acidHRadiusForCavEnergy','solventRadius','solventRho','solventAtoms'), suffix=r'\b'),
             Name.Builtin),
        ],
        "bool": [
            (words((
                'Nosymm', 'norotate', 'skeleton', 'saorb', 'check', 'restart', 'extcharge', 'uncontract', 'primitive', 'direct', 'scalar','direct','soint','NuclearInuc', 'RHF','UHF','ROHF','RKS','UKS','ROKS','D3','NosymGrid','DirectGrid','NoDirectGrid','NoGridSwitch','COSX','MPEC+COSX','NoDiis','Noscforb','Pyscforb','Molden','Checklin','Aokxc','Lefteig','Geom','Line','Quad','Fnac','Single','Double','Noresp','Fdif','Reduced','GSApr','Boys','Pipek','Mulliken','Lowdin','Jacobi','Trust','Rohfloc','Mcscffloc','Orbread','Flmo','Anaylze','Momatch','Directgrid','Overlap','UTDDFT','TDDFT','FCIDUMP','Nature','Dryrun','PHO','Readhess','Dimer','NoInterpolation','Crude','NEB','SolNeqSS','solneqlr','soleqlr','grimmestd'), suffix=r'\b'),
            Name.Attribute),
        ],
        "values": [
            (words((
