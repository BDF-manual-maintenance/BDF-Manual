    ...
    tokens = {
        ...
        "keywords": [
            (words((
                ...
                'Spinmulti','icg','igiao','igatom','cgcoord','cgunit','solvent','solmodel','cavity','acidHRadius','radii','vdWScale','crit_vec','gridtol','locales','iwindow'), suffix=r'\b'),
             Name.Builtin),
        ],
        "bool": [
            (words((
