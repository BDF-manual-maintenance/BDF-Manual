 ...
 * Hamiltonian：计算任务考虑相对论效应时采用的哈密顿量，BDF支持多种相对论效应的计算，具体细节参见 :doc:`Introduction`，考虑到大部分用户的使用习惯和理论基础，当前的图形界面提供了 **Non-relativistic（非相对论）**， **ECP**， **sf-X2C**和 **X2C** 四种选项。其中 **X2C** 尚未在当前发布的BDF版本种支持，故界面上不允许用户选择，在未来BDF更新相关功能之后才会解锁。